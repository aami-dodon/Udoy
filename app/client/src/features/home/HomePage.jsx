...
const roles = [
  {
    name: 'Students',
    description:
      'Young dreamers accessing world-class, 2025-ready learning that nurtures confidence, curiosity, and grit.',
    icon: 'Sparkles',
    highlight: 'Every milestone unlocks transparent rewards funded by the community.',
  },
  {
    name: 'Creators (Ex-Students)',
    description:
      'Graduates who return to craft relevant lessons rooted in their lived experiences and local realities.',
    icon: 'PenTool',
    highlight: 'Content stays authentic, relatable, and deeply actionable for every learner.',
  },
  {
    name: 'Teachers',
    description:
      'Retired and experienced educators who elevate every module with structure, clarity, and pedagogy.',
    icon: 'GraduationCap',
    highlight: 'Quality checks ensure each lesson guides students from basics to mastery.',
  },
  {
    name: 'Coaches',
    description:
      'Remote mentors helping students find their strengths, build confidence, and stay accountable.',
    icon: 'Compass',
    highlight: 'Guided check-ins keep learning personal, encouraging, and purposeful.',
  },
  {
    name: 'Sponsors',
    description:
      'Individuals and organisations funding student achievements through transparent token rewards.',
    icon: 'Coins',
    highlight: 'Impact dashboards prove how every contribution changes a learner’s trajectory.',
  },
];
...
const flywheel = [
  {
    title: 'Learn',
    description: 'Students access curated paths, blending adaptive content with real-life problem solving.',
    icon: 'BookOpen',
  },
  {
    title: 'Create',
    description: 'Graduates become creators, translating success stories into fresh lessons and tools.',
    icon: 'Loop',
  },
  {
    title: 'Elevate',
    description: 'Teachers refine content, coaches mentor progress, and sponsors unlock the next opportunity.',
    icon: 'ArrowBigUpDash',
  },
  {
    title: 'Inspire',
    description: 'Empowered students re-enter the ecosystem to lift the next cohort even higher.',
    icon: 'Star',
  },
];

const impactMetrics = [
  { value: '92%', label: 'students show measurable growth within 6 months.' },
  { value: '4.7/5', label: 'average learner confidence rating after guided coaching.' },
  { value: '100%', label: 'sponsor contributions mapped transparently to achievements.' },
];
...
const faqs = [
  {
    ...
    answer:
      'Every token is tracked on a public impact ledger. Sponsors see which milestones were unlocked, the student who earned them, and the next goal in their journey.',
  },
  {
    question: 'Can I volunteer from outside India?',
    answer:
      'Absolutely. Udoy is built for remote collaboration. Coaches receive training, digital toolkits, and timezone-friendly schedules to mentor from anywhere.',
  },
  {
    question: 'What support do creators receive?',
    answer:
      'Creators co-build with teachers and product mentors, ensuring every lesson is technically sound, accessible in low-bandwidth environments, and ready for review before launch.',
  },
  {
    question: 'How are students onboarded?',
    answer:
      'Community partners and grassroots organisations help identify learners. Each student receives a personalised learning path, device support guidance, and a dedicated coach for accountability.',
  },
];
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-4">
              <h1 className="font-display text-4xl leading-tight text-white sm:text-5xl lg:text-6xl">
                Udoy is the launchpad for children ready to rise above circumstance.
              </h1>
              <p className="body-large max-w-2xl text-white/80">
                We power a cycle of learning, mentorship, and transparent rewards so underrepresented talent can emerge, excel,
            ...
            <div className="flex flex-wrap gap-6 text-sm text-white/70">
              <div className="flex items-center gap-3">
                ...
                12,000+ hours of mentorship delivered remotely
              </div>
              <div className="flex items-center gap-3">
                <LucideIcon name="ShieldCheck" size="sm" />
                Safeguarded onboarding and verified impact reporting
              </div>
            </div>
          </div>
        ...
        <div className="grid gap-12 md:grid-cols-[0.8fr,1fr] md:items-center">
          <div className="space-y-6">
            ...
            <p className="body-large">
              Udoy orchestrates a supportive ecosystem where alumni creators, seasoned teachers, remote coaches, and transparent
              sponsors rally around each learner. Together, they form an unbroken chain of belonging, mastery, and purpose.
            </p>
            <div className="grid gap-6 sm:grid-cols-2">
              <div className="rounded-2xl bg-white/80 p-6 shadow-gentle">
                ...
                <p className="mt-2 text-sm text-neutral-600">
                  A caring network surrounds every child with mentorship, emotional safety, and courage to dream big.
                </p>
              </div>
              <div className="rounded-2xl bg-white/80 p-6 shadow-gentle">
                <h3 className="text-xl font-semibold text-evergreen">Pathways that scale</h3>
                <p className="mt-2 text-sm text-neutral-600">
                  Dynamic roadmaps adapt to each learner, blending foundational skills with future-ready opportunities.
                </p>
              </div>
            </div>
          </div>
          <div className="relative">
            <div className="surface-card space-y-6">
              ...
              <p className="text-sm text-neutral-600">
                Each contribution fuels a transparent journey from learning to leadership.
              </p>
        ...
        <div className="container section">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <p className="body-large mt-4">
              We celebrate collaboration. Each role feeds the next, building a rising tide where excellence becomes collective.
            </p>
          </div>
      ...
      <section id="impact" className="container section">
        <div className="grid gap-10 lg:grid-cols-[1fr,0.8fr]">
          <div className="space-y-8">
            ...
            <p className="body-large">
              Become a sponsor, coach, or community partner. Together, we can make sure brilliance is no longer limited by
              circumstance.
            </p>
            <div className="grid gap-6 sm:grid-cols-2">
              <div className="rounded-2xl border border-porcelain-shade bg-white/70 p-6">
                ...
                <p className="mt-2 text-sm text-neutral-600">
                  Fund achievement tokens, devices, and community labs. Track every learner you empower.
                </p>
              ...
              <div className="rounded-2xl border border-porcelain-shade bg-white/70 p-6">
                ...
                <p className="mt-2 text-sm text-neutral-600">
                  Guide 2–3 learners weekly, with structured prompts and support from lead mentors.
                </p>
                <Button variant="link" className="mt-4 px-0 text-evergreen">
            ...
            <div className="flex flex-wrap gap-3 text-sm text-neutral-600">
              <div className="flex items-center gap-2">
                ...
                Cohort onboarding every quarter
              </div>
              <div className="flex items-center gap-2">
                <LucideIcon name="Globe" size="sm" className="text-evergreen" />
                Remote-first, globally inclusive
              </div>
            </div>
          ...
          <div className="surface-card">
            ...
            <p className="mt-2 text-sm text-neutral-600">
              Every action sparks the next. Sponsors unlock access, students grow, alumni return, and the cycle compounds.
            </p>
      ...
      <section className="bg-porcelain-tint/60">
        <div className="container section">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <p className="body-large mt-4">
              Still curious about how Udoy works? Explore the most common questions from our community.
            </p>
          </div>
          ...
          <div className="grid gap-12 md:grid-cols-[2fr,1fr]">
            <div className="space-y-4">
              ...
              <p className="max-w-xl text-sm text-white/70">
                Udoy builds equitable access to future-ready learning. Together, we nurture resilience, celebrate progress, and
                make opportunity undeniable.
              </p>
              <div className="flex flex-wrap gap-4">
                <Button className="bg-white text-black-olive hover:bg-porcelain">Sponsor a learner</Button>
