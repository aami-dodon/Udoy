...
export const ROLE_DEFINITIONS = [
  {
    ...
    permissions: [
      ...
      },
      {
        ...
        resource: 'topic',
        action: 'manage',
        description: 'Moderate topics, override workflow states, and manage taxonomy.',
      },
      {
        name: 'topic.publish',
        resource: 'topic',
        action: 'publish',
        description: 'Publish approved topics to the learning library.',
      },
      {
        name: 'topic.view',
        resource: 'topic',
        action: 'view',
        description: 'View topic catalog, statuses, and workflow history.',
      },
    ],
  },
  {
  ...
  },
  {
    ...
    permissions: [
      ...
      },
      {
        ...
        resource: 'topic',
        action: 'draft',
        description: 'Create and edit topic drafts, metadata, and accessibility notes.',
      },
      {
        name: 'topic.submit',
        resource: 'topic',
        action: 'submit',
        description: 'Submit topics for validator review with change notes.',
      },
      {
        name: 'topic.publish',
        resource: 'topic',
  ...
  },
  {
    ...
    permissions: [
      ...
      },
      {
        ...
        resource: 'topic',
        action: 'review',
        description: 'Review submitted topics, leaving structured decisions and comments.',
      },
      {
        name: 'topic.approve',
        resource: 'topic',
        action: 'approve',
        description: 'Approve validated topics prior to publication.',
      },
      {
        name: 'topic.requestChanges',
        resource: 'topic',
        action: 'request-changes',
        description: 'Request content, accessibility, or alignment changes during review.',
      },
      {
        name: 'topic.view',
        resource: 'topic',
